...
export function FAQSection() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Depende del proyecto y las funcionalidades que se quieran tener. Un proyecto medio con una web y unas cuantas funcionalidades tarda aproximadamente de 3 a 4 semanas.",
    },
        {
      question: "¿En qué plazo entregáis un dashboard de indicadores?",
      answer: "Normalmente de 2 a 3 semanas, dependiendo de la complejidad.",
    },
  ]

  // Genera el JSON-LD a partir de tu array de FAQs
  const faqJsonLd = {
      ...
      <section id="faq" className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400">Resolvemos las dudas más comunes sobre nuestros servicios en Tenerife y Canarias</p>
          </div>
